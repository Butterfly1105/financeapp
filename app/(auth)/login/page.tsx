    ...
    <div className="min-h-screen flex items-center justify-center bg-[#09090b] px-4">
      ...
      <div className="relative w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-zinc-50">Bem-vindo de volta</h1>
          <p className="text-zinc-400 mt-1">Entre na sua conta para continuar</p>
        </div>
        ...
        <div className="bg-[#18181b] border border-zinc-800 rounded-2xl p-8 shadow-2xl">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-[#1c1c1f] hover:bg-[#222226] border border-zinc-700 text-zinc-200 rounded-xl px-4 py-3 text-sm font-medium transition-all duration-200 disabled:opacity-50 mb-6"
          >
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="px-3 bg-[#18181b] text-zinc-500">ou continue com email</span>
            </div>
          </div>
